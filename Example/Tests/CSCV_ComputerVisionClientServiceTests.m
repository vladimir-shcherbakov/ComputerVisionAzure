...
@end
@implementation CSCV_ComputerVisionClientServiceTests
- (void)setUp {
    ...
    self.service = [CSCV_ComputerVisionClientService createWithEndpoint:endpoing
...
- (void) test_listModels {
    ...
    [self.service listModelsWithCallback:^(CSCV_ListModelsResult* result, AZOperationError* error) {
...
- (void) test_analyzeImage {
    ...
    [self.service analyzeImageWithUrl:url withVisualFeatures:visualFeatures withDetails:details withLanguage:language withCallback:^(CSCV_ImageAnalysis* result, AZOperationError* error) {
        [waitingLoading fulfill];
        XCTAssertNil(error, @"%@", error.reason);
        XCTAssertNotNil(result);
    }];
...
- (void) test_generateThumbnail {
    ...
    [self.service generateThumbnailWithWidth:width withHeight:height withUrl:url withSmartCropping:smartCropping withCallback:^(AZStream* result, AZOperationError* error) {
        [waitingLoading fulfill];
        XCTAssertNil(error, @"%@", error.reason);
        XCTAssertNotNil(result);
    }];
...
- (void) test_recognizePrintedText {
    ...
    [self.service recognizePrintedTextWithDetectOrientation:detectOrientation withUrl:url withLanguage:language withCallback:^(CSCV_OcrResult* result, AZOperationError* error) {
        [waitingLoading fulfill];
        XCTAssertNil(error, @"%@", error.reason);
        XCTAssertNotNil(result);
    }];
...
- (void) test_describeImage {
    ...
    NSString* language = @"en";
    [self.service describeImageWithUrl:url withMaxCandidates:maxCandidates withLanguage:language withCallback:^(CSCV_ImageDescription* result, AZOperationError* error) {
        [waitingLoading fulfill];
        XCTAssertNil(error, @"%@", error.reason);
        XCTAssertNotNil(result);
    }];
...
- (void) test_tagImage {
    ...
    NSString* url = @"https://testpictures.blob.core.windows.net/cogsrv/analyze1.jpg";
    NSString* language = @"en";
    [self.service tagImageWithUrl:url withLanguage:language withCallback:^(CSCV_TagResult* result, AZOperationError* error) {
        [waitingLoading fulfill];
        XCTAssertNil(error, @"%@", error.reason);
        XCTAssertNotNil(result);
    }];
...
- (void) test_analyzeImageByDomain {
    ...
    NSString* language = @"en";
    [self.service analyzeImageByDomainWithModel:model withUrl:url withLanguage:language withCallback:^(CSCV_DomainModelResults* result, AZOperationError* error) {
        [waitingLoading fulfill];
        XCTAssertNil(error, @"%@", error.reason);
        XCTAssertNotNil(result);
    }];
...
- (void) test_analyzeImageInStream {
    ...
    NSArray<CSCV_VisualFeatureTypes*>* visualFeatures = nil;
    NSArray<CSCV_Details*>* details = @[CSCV_Details.CELEBRITIES];
    NSString* language = @"en";
    [self.service analyzeImageInStreamWithImage:image withVisualFeatures:visualFeatures withDetails:details withLanguage:language withCallback:^(CSCV_ImageAnalysis* result, AZOperationError* error) {
        [waitingLoading fulfill];
        XCTAssertNil(error, @"%@", error.reason);
        XCTAssertNotNil(result);
...
- (void) test_generateThumbnailInStream {
    ...
    AZStream* image = [self readImageFileWithName:@"celebrity" ofType:@"jpeg"];
    AZBoolean* smartCropping = AZ_NO;
    [self.service generateThumbnailInStreamWithWidth:width withHeight:height withImage:image withSmartCropping:smartCropping withCallback:^(AZStream* result, AZOperationError* error) {
        [waitingLoading fulfill];
        XCTAssertNil(error, @"%@", error.reason);
        XCTAssertNotNil(result);
    }];
...
- (void) test_recognizePrintedTextInStream {
    ...
    CSCV_OcrLanguages* language = [[CSCV_OcrLanguages values] firstObject];
    [self.service recognizePrintedTextInStreamWithDetectOrientation:detectOrientation withImage:image withLanguage:language withCallback:^(CSCV_OcrResult* result, AZOperationError* error) {
        [waitingLoading fulfill];
        XCTAssertNil(error, @"%@", error.reason);
        XCTAssertNotNil(result);
    }];
...
- (void) test_describeImageInStream {
    ...
    AZInteger* maxCandidates = @1;
    NSString* language = @"en";
    [self.service describeImageInStreamWithImage:image withMaxCandidates:maxCandidates withLanguage:language withCallback:^(CSCV_ImageDescription* result, AZOperationError* error) {
        [waitingLoading fulfill];
        XCTAssertNil(error, @"%@", error.reason);
        XCTAssertNotNil(result);
    }];
...
- (void) test_tagImageInStream {
    ...
    AZStream* image = [self readImageFileWithName:@"analyze3" ofType:@"jpg"];
    NSString* language = @"en";
    [self.service tagImageInStreamWithImage:image withLanguage:language withCallback:^(CSCV_TagResult* result, AZOperationError* error) {
        [waitingLoading fulfill];
        XCTAssertNil(error, @"%@", error.reason);
        XCTAssertNotNil(result);
    }];
...
- (void) test_analyzeImageByDomainInStream {
    ...
    AZStream* image = [self readImageFileWithName:@"celebrity" ofType:@"jpeg"];
    NSString* language = @"en";
    [self.service analyzeImageByDomainInStreamWithModel:model withImage:image withLanguage:language withCallback:^(CSCV_DomainModelResults* result, AZOperationError* error) {
        [waitingLoading fulfill];
        XCTAssertNil(error, @"%@", error.reason);
        XCTAssertNotNil(result);
    }];
